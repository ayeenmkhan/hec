...
<div id="main-container">
  ...
  <ol class="breadcrumb"><li class="active">Dashboard</li></ol>
    ...
    <div class="costom-border-line">
        <form action="<?php echo SURL?>manage_user/assign_permission" enctype="multipart/form-data" method="post" id="frm_add" >
        <div id="pass_res"></div>
        <!-- /.row -->
       ...
       <div class="checkbox">
        ...
        <!--<input type="text" placeholder="CNIC" required name="cnic" class="form-control">-->   
         </div>     
